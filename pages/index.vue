<template>
    <div class="grid m-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-4">
        <div v-for="(apartment, index) in apartments" :key="apartment.id" class="card bg-base-100 shadow-xl"
