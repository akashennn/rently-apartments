<template>
    <div class="flex flex-1 justify-center bg-[#f7f7fa]">
        <div class="w-[1024px] h-screen p-3 bg-white">
            <div class="flex flex-1 justify-center">
                <img class="h-[300px] object-cover" :src="inventoryItem.image || defaultImageURL"
            ...
            <div v-if="isReadyOnly" class="flex flex-1 flex-col mt-3 justify-center">
                <button class="btn btn-sm btn-secondary mb-2 flex-1" @click="onDelete">
                ...
                <button class="btn btn-sm btn-primary flex-1" @click="onEdit">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-4 h-4 mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round"
